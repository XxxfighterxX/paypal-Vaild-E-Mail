print("Check Your Maillist")
import requests
live = open('LIVE_AHMED.txt', 'w')
die = open('DIE_AHMED.txt', 'w')
Checked = "Checked by Ahmed Essam Valid Email Checker"
print("_"*50)
print("EMAIL CHECKER PAYPAL BY Ahmed Essam")
print("Contact Me : https://www.facebook.com/XXxFighterxXX")
print("https://github.com/XxxfighterxX")
print"Happy spam"
print("_"*55)
print" "
list=raw_input("Here put Mail List :")
...
while True:
	...
	if "You indicated you are a new customer, but an account already exists with the e-mail" in cek:
		print("\033[32;1mLIVE\033[0m | "+email+" | [(GOOD)]")
		live.write(email + '\n')
	else:
		print("\033[31;1mDIE\033[0m | "+email+" | [(Fucked)]")
		die.write(email + '\n')
print("-"*50)
print("\033[35;1mProccess Checking Done\033[0m")
print("PayPal Valid Email was Saved in LIVE_AHMED.txt")
